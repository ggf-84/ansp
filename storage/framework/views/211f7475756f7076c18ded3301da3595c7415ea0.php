                                        ...
                                        <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif($row->type == 'text'): ?>
                                                    ...
                                                    <div><?php echo e(mb_strlen( $data->{$row->field} ) > 50 ? mb_substr($data->{$row->field}, 0, 50) . ' ...' : $data->{$row->field}); ?></div>
                                                ...
                                                <?php elseif($row->type == 'rich_text_box'): ?>
                                                    <?php echo $__env->make('voyager::multilingual.input-hidden-bread-browse', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    <div><?php echo e(mb_strlen( strip_tags($data->{$row->field}, '<b><i><u>') ) > 50 ? mb_substr(strip_tags($data->{$row->field}, '<b><i><u>'), 0, 50) . ' ...' : strip_tags($data->{$row->field}, '<b><i><u>')); ?></div>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gg/www/NahabaGroup/ansp/vendor/tcg/voyager/src/../resources/views/bread/browse.blade.php ENDPATH**/ ?>